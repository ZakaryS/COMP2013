 ...
 */
//WRITE YOUR CODE BELOW
const realtorFees = (obj) => { return (Number(obj.price.replace(/\D/g, '')) <= 450000) ? Number(obj.price.replace(/\D/g, '')) * .025 : (Number(obj.price.replace(/\D/g, '')) > 450000) ? Number(obj.price.replace(/\D/g, '')) * 0.02 : "How did you do this?"; }
 ...
 */
//WRITE YOUR CODE BELOW
let listingAscendingly = [...listings].sort((a, b) => {return Number(a.price) - Number(b.price)});
 ...
 */
//WRITE YOUR CODE BELOW
let newBuildListings = listings.filter(obj => Number(obj.propertySummary.builtIn) >= 1990);
console.log(newBuildListings);